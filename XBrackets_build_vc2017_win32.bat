...
:Building
cd .\XBrackets
msbuild XBrackets_VC2017.vcxproj /t:Clean /p:Configuration=Release;Platform=Win32 /m:2
msbuild XBrackets_VC2017.vcxproj /t:Build /p:Configuration=Release;Platform=Win32 /m:2
goto End

...
:Building
cd .\XBrackets
msbuild XBrackets_VC2022.vcxproj /t:Clean /p:Configuration=Release;Platform=x64 /m:2
msbuild XBrackets_VC2022.vcxproj /t:Build /p:Configuration=Release;Platform=x64 /m:2
goto End
